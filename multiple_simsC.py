...
def run():
    ...
    if run_button:
        ...
        ax.set_ylabel(f'Fraction where g_S values > multiplier × g_S values', fontsize=12)
        ax.set_title('Fraction of Simulations where Accelerated Case growth exceeds Base case growth over time', fontsize=14)
