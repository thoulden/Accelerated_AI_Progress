...
def run():
    ...
    ly_low = st.sidebar.number_input("Years to Ceiling; lower bound", min_value=1.0, value=5.0)
    ly_high = st.sidebar.number_input("Years to Ceiling; upper bound", min_value=ly_low, value=13.0)
    lf_low = st.sidebar.number_input(r"Parallelizability ($\lambda$); lower bound", min_value=0.01, value=0.15)
