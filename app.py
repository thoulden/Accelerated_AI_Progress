...
For additional detalis on this derivation are provided in the [appendix](https://www.forethought.org/research/how-quick-and-big-would-a-software-intelligence-explosion-be#appendix) of the post.""")
