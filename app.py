...
st.markdown(r"""
This tool is a simulation companion to [How quick and big would a software intelligence explosion be?](https://www.forethought.org/research/how-quick-and-big-would-a-software-intelligence-explosion-be)  Alongside the ability to change parameterizations (in the sidebar), users have two main simulation options:
...
Additional details for this derivation as well as discussion of objections to our choice of model inputs are provided in the [appendix](https://www.forethought.org/research/how-quick-and-big-would-a-software-intelligence-explosion-be#appendices) of the post.""")
